...
CREATE TABLE IF NOT EXISTS fixtures (
    ...
    KEY idx_fixture_kickoff (kickoff),
...
CREATE TABLE IF NOT EXISTS team_match_stats (
    ...
    xg DECIMAL(7,3) NULL,
    xgot DECIMAL(7,3) NULL,
    expected_assists DECIMAL(7,3) NULL,
    possession DECIMAL(5,2) NULL,
    shots SMALLINT UNSIGNED NULL,
    shots_on_target SMALLINT UNSIGNED NULL,
    shots_off_target SMALLINT UNSIGNED NULL,
    blocked_shots SMALLINT UNSIGNED NULL,
    shots_inside_box SMALLINT UNSIGNED NULL,
    shots_outside_box SMALLINT UNSIGNED NULL,
    woodwork SMALLINT UNSIGNED NULL,
    big_chances SMALLINT UNSIGNED NULL,
    corners SMALLINT UNSIGNED NULL,
    touches_opposition_box SMALLINT UNSIGNED NULL,
    offsides SMALLINT UNSIGNED NULL,
    free_kicks SMALLINT UNSIGNED NULL,
    passes_attempted SMALLINT UNSIGNED NULL,
    passes_completed SMALLINT UNSIGNED NULL,
    pass_accuracy DECIMAL(5,2) NULL,
    long_passes_attempted SMALLINT UNSIGNED NULL,
    long_passes_completed SMALLINT UNSIGNED NULL,
    long_pass_accuracy DECIMAL(5,2) NULL,
    final_third_passes_attempted SMALLINT UNSIGNED NULL,
    final_third_passes_completed SMALLINT UNSIGNED NULL,
    final_third_pass_accuracy DECIMAL(5,2) NULL,
    crosses_attempted SMALLINT UNSIGNED NULL,
    crosses_completed SMALLINT UNSIGNED NULL,
    cross_accuracy DECIMAL(5,2) NULL,
    fouls SMALLINT UNSIGNED NULL,
    yellow_cards SMALLINT UNSIGNED NULL,
    red_cards SMALLINT UNSIGNED NULL,
    tackles_attempted SMALLINT UNSIGNED NULL,
    tackles_won SMALLINT UNSIGNED NULL,
    duels_won SMALLINT UNSIGNED NULL,
    clearances SMALLINT UNSIGNED NULL,
    interceptions SMALLINT UNSIGNED NULL,
    errors_leading_to_shot SMALLINT UNSIGNED NULL,
    errors_leading_to_goal SMALLINT UNSIGNED NULL,
    goalkeeper_saves SMALLINT UNSIGNED NULL,
    xgot_faced DECIMAL(7,3) NULL,
    goals_prevented DECIMAL(7,3) NULL,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY uq_fixture_team_period (fixture_id, team_id, period),
    KEY idx_stats_team (team_id),
...
CREATE TABLE IF NOT EXISTS api_snapshots (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    provider VARCHAR(50) NOT NULL DEFAULT 'flashscore4',
    ...
    KEY idx_snapshot_entity (entity_type, entity_id),
    KEY idx_snapshot_endpoint (endpoint)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
